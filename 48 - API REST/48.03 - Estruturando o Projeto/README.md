...
O **nodemon** é uma ferramenta de desenvolvimento que monitora as mudanças em arquivos do projeto e reinicia automaticamente o servidor ou aplicação quando detecta alterações. Ele é especialmente útil para acelerar o processo de desenvolvimento, eliminando a necessidade de reiniciar manualmente o servidor toda vez que fazemos uma modificação no código.
